...
def index():
    if request.method == 'POST':
        ...
        # Define features
        features = ['edad', 'sexo', 'fiebre', 'diarrea']
        ...
        new_data = pd.DataFrame([[edad, sexo, fiebre, diarrea]], columns=features)
        ...
        return jsonify(predicted_clasfinal=predicted_clasfinal, predicted_tip_cas=predicted_tip_cas)
